        ...
        <tbody>
            ...
            <tr class="hover:bg-gray-50">
                <td class="p-4 border-b">
                    <img src="{{ $course->image ? asset('storage/'.$course->image) : 'https://via.placeholder.com/100' }}" class="w-16 h-10 object-cover rounded">
                </td>
                <td class="p-4 border-b font-semibold">{{ $course->title }}</td>
