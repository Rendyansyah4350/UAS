    ...
    <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div>
                ...
                <textarea name="description" rows="4" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-gray-50" placeholder="Jelaskan apa yang akan dipelajari student..."></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="price" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm p-2 bg-gray-50" placeholder="Contoh: 150000">
                </div>
            ...
            <div class="flex justify-end space-x-3 mt-4">
                <a href="{{ route('admin.courses.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300">Batal</a>
