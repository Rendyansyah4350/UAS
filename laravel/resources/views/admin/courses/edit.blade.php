    ...
    <form action="{{ route('admin.courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                ...
                <input type="text" name="title" value="{{ $course->title }}" required class="mt-1 block w-full border rounded-md p-2 bg-gray-50">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="price" value="{{ $course->price }}" required class="mt-1 block w-full border rounded-md p-2 bg-gray-50">
                </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('admin.courses.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg">Batal</a>
